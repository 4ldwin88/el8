import { QUESTIONS, ANSWERS, EFFECTS, SIGNALS, ACTIONS, EVIDENCE, SOURCES, ID_MIGRATION_MAP, ORIENTATION_BASELINE_QUESTIONS, ORIENTATION_BASELINE_ANSWERS, ORIENTATION_BASELINE_EFFECTS, ORIENTATION_BASELINE_SOURCES, BASELINE_DISCRIMINATOR_QUESTIONS, BASELINE_DISCRIMINATOR_ANSWERS, BASELINE_DISCRIMINATOR_EFFECTS } from './index.js';

export const ALL_QUESTIONS = Object.freeze([...QUESTIONS,...ORIENTATION_BASELINE_QUESTIONS,...BASELINE_DISCRIMINATOR_QUESTIONS]);
export const ALL_ANSWERS = Object.freeze([...ANSWERS,...ORIENTATION_BASELINE_ANSWERS,...BASELINE_DISCRIMINATOR_ANSWERS]);
export const ALL_EFFECTS = Object.freeze([...EFFECTS,...ORIENTATION_BASELINE_EFFECTS,...BASELINE_DISCRIMINATOR_EFFECTS]);

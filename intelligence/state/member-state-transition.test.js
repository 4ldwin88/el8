...
s=apply(s,{type:E.FOCUS_DECIDED,payload:{constructId:'FINANCIAL_STRAIN',decision:'postponed',decidedAt:at,reasonCodes:['member_choice']},source:'member',at,expectedRevision:5});
...
// Member State flags reconciliation; it does not silently rewrite Planning output.

...
assert.throws(()=>confirmFocus({prioritization,decisions:[{constructId:'SOCIAL_CONNECTION',decision:'accepted'}],decidedAt:at}),/not a legitimate Prioritization candidate/);

...
assert.equal(Object.hasOwn(BANK[0],'legacyId'),false);
assert.equal(BANK[0].options.length,14);
assert.deepEqual(normalizeAnswerIds(BANK[0],['GEN001.01']),[],'retired aliases cannot execute');
assert.deepEqual(normalizeAnswerIds(BANK[0],['A000001']),['A000001']);

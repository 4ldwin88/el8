...
// between dimensions live in cross-dimensional.js.
export const OCCUPATIONAL_QUESTIONS = Object.freeze([
  ...
  Q('W3', 'discriminator', 'What part of work or school is hardest right now?', ['work_instability', 'schedule_disruption'], [
    ['stability', 'Not knowing what will happen', { work_instability: 0.6 }],
    ['schedule', 'Hours or schedule', { schedule_disruption: 0.6 }],
    ['load', 'Too much to do', { stress: 0.25, low_energy: 0.2 }],
    ['fit', 'It does not feel like a good fit', { lack_direction: 0.3 }],
    ['none', 'Nothing major', { work_instability: -0.45, schedule_disruption: -0.35 }],
  ], 0.22),
  Q('W4', 'confirmation', 'If work became stable tomorrow, would a lot of the current pressure ease?', ['work_instability'], [
    ['yes', 'Yes', { work_instability: 0.55 }],
    ['some', 'Some of it', { work_instability: 0.25 }],
    ['no', 'Not much', { work_instability: -0.35 }],
    ['unsure', 'Not sure', {}],
  ], 0.2),
  ...
  Q('SC2', 'confirmation', 'Does your schedule regularly push sleep, meals, or routines off track?', ['schedule_disruption'], [
    ['no', 'No', { schedule_disruption: -0.6 }],
    ['sometimes', 'Sometimes', { schedule_disruption: 0.3 }],
    ['often', 'Often', { schedule_disruption: 0.7 }],
  ], 0.18),
]);

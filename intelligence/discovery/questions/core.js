...
export const CORE_QUESTIONS = Object.freeze([
  ...
  Q('O2', 'orientation', 'Thinking about the past 7 days, on how many days were you physically active for at least 20 minutes?', [], [
    ['most', '5–7 days', { low_activity: -0.6 }],
    ['some', '2–4 days', { low_activity: -0.25 }],
    ['one', '1 day', { low_activity: 0.35 }],
    ['none', '0 days', { low_activity: 0.7 }],
    ['unsure', 'Not sure', {}],
  ], 0.1),
  Q('O3', 'orientation', 'When life has been going well, what has most helped you keep going?', [], [
  ...
  Q('O4', 'orientation', 'Thinking about recent difficult days, what has most often made the day harder?', [], [
  ...
  Q('O5', 'orientation', 'What would you most like EL8 to help you with right now?', [], [
  ...
  Q('G1', 'gateway', 'Thinking about the past 7 days, which of these have made daily life harder? Select any that fit.', [], [
    ...
    ['stress', 'Stress or difficult emotions', { stress: 0.6 }],
    ...
    ['focus', 'Focus or getting started', { low_focus: 0.35, low_activation: 0.25 }],

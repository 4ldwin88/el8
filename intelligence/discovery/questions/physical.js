...
export const PHYSICAL_QUESTIONS = Object.freeze([
  ...
  Q('PH1B', 'feasibility-probe', 'What could limit physical activity for you right now? Select any that fit.', ['low_activity'], [
    ['time', 'Time or schedule', { schedule_disruption: 0.18 }],
    ['cost', 'Cost', { money_pressure: 0.12 }],
    ['space', 'Space or location', { home_instability: 0.08 }],
    ['mobility', 'Mobility or accessibility', { physical_condition: 0.12 }],
    ['pain', 'Pain or physical symptoms', { physical_condition: 0.2 }],
    ['health_guidance', 'I need professional guidance before changing activity', { physical_condition: 0.15 }],
    ['motivation', 'Motivation or getting started', { low_activation: 0.25 }],
  ...
  Q('PH2', 'state-probe', 'Are weight, fitness, or your physical condition bothering you right now?', ['physical_condition'], [
    ['no', 'No', { physical_condition: -0.65 }], ['little', 'A little', { physical_condition: 0.25 }], ['yes', 'Yes', { physical_condition: 0.7 }], ['unsure', 'Not sure', {}],
  ], 0.17),
  Q('PH2A', 'feasibility-probe', 'If EL8 suggested a physical-health action, what should it account for?', ['physical_condition'], [
    ['cost', 'Keep cost very low', { money_pressure: 0.08 }], ['time', 'Keep it short', { schedule_disruption: 0.08 }], ['accessibility', 'Accessibility or mobility needs', { physical_condition: 0.1 }], ['symptoms', 'Pain, symptoms, or a health condition', { physical_condition: 0.18 }], ['professional', 'Professional guidance may be needed', { physical_condition: 0.12 }], ['none', 'No special limitation', {}],
  ], 0.1, 'multi'),
  Q('PH3', 'state-probe', 'How hard has it been to get yourself started on things you intend to do?', ['low_activation'], [
    ['easy', 'Usually easy', { low_activation: -0.65 }], ['sometimes', 'Sometimes hard', { low_activation: 0.3 }], ['hard', 'Often hard', { low_activation: 0.7 }], ['unsure', 'Not sure', {}],
  ], 0.17),
  ...
  Q('SL2', 'discriminator', 'What seems to interfere with sleep most?', ['poor_sleep'], [
    ['schedule', 'Schedule or timing', { schedule_disruption: 0.55 }], ['stress', 'Stress or thoughts', { stress: 0.45 }], ['home', 'Home or surroundings', { home_instability: 0.4 }], ['body', 'Physical discomfort or health', { poor_sleep: 0.25, physical_condition: 0.15 }], ['unsure', 'Not sure', {}],
  ], 0.2),
  Q('SL3', 'confirmation', 'When you sleep better, does your energy or focus noticeably improve?', ['poor_sleep'], [
    ['yes', 'Yes', { poor_sleep: 0.35, low_energy: 0.15, low_focus: 0.1 }], ['some', 'Somewhat', { poor_sleep: 0.15 }], ['no', 'Not really', { poor_sleep: -0.2 }],
  ], 0.18),

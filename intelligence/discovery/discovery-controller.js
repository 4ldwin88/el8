...
export function createDiscoverySession({concernIds=[],questionBank=[],labels={},outerGuardrail=18,orientationLimit=null,facts={}}={}){return{version:DISCOVERY_VERSION,observationLog:[],facts:{...facts},concernIds:[...concernIds],questionBank,labels,asked:[],questionsAsked:0,outerGuardrail,orientationLimit:Number.isInteger(orientationLimit)&&orientationLimit>=0?orientationLimit:null,phase:'orient',triaged:false,incomplete:false,resolutionStates:{},driverKnown:{},recoveryAttempts:{},priorityResolutionUsed:false}}

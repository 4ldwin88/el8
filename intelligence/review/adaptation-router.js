...
export function routeReview({review={},plan={}}={}){
 ...
 switch(review.decision){
  ...
  case'replace':return freeze({route:'planning',actionIds:freeze(actionIds),rejectedActionIds:freeze(actionIds),adaptationConstraint:'different_intervention',instruction:'Return to Planning; do not reselect the ineffective intervention without new evidence.',preservePlan:false});

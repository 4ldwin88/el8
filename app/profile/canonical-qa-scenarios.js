export const CANONICAL_QA_SCENARIOS=Object.freeze([
 ...
 {id:'replace',label:'No benefit → replace',adherence:'high',outcome:'unchanged',burden:'low',expected:{decision:'replace',route:'planning',adaptationConstraint:'different_mechanism'}},

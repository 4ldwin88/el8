export const QA_SCENARIOS=Object.freeze([
...
export function qaScenario(id){const x=QA_SCENARIOS.find(s=>s.id===id);if(!x)throw new Error(`Unknown QA scenario: ${id}`);return x}

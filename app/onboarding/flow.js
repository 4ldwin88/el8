...
// Discovery owns initial assessment. Its opening snapshot establishes broad starting evidence;
// the immutable baseline is created later when Discovery is projected into Member State.
...
export const ONBOARDING_ROUTES = Object.freeze({[ONBOARDING_STATES.NOT_STARTED]:'discovery-snapshot.html',[ONBOARDING_STATES.IN_PROGRESS]:'discovery-snapshot.html',[ONBOARDING_STATES.COMPLETE]:'home.html',[ONBOARDING_STATES.SAFETY_PAUSED]:'safety-hold.html'});
// Legacy granular statuses remain readable only as migration aliases. They do not define the current architecture.
const LEGACY_ROUTES=Object.freeze({new:'discovery-snapshot.html',profile_complete:'discovery-snapshot.html',baseline_required:'discovery-snapshot.html',baseline_complete:'discovery.html',discovery_required:'discovery.html',discovery_complete:'proposed-priorities.html',plan_required:'plan-proposal.html',plan_proposed:'plan-proposal.html',plan_acceptance_required:'plan-proposal.html',plan_accepted:'app-introduction.html',preferences_required:'app-introduction.html',preferences_complete:'app-introduction.html',introduction_required:'app-introduction.html',onboarded:'home.html',complete:'home.html'});

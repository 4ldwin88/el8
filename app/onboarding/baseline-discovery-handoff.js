...
export function buildBaselineDiscoveryHandoff(derived={}){
 ...
 return Object.freeze({version:'baseline-discovery-handoff-v3.1',candidateDimensions,candidateConcerns,signals:Object.freeze({dimensionSignals,impact,worsening,priority,priorityConcerns:Object.freeze([...priorityConcerns]),concernEmphasis:Object.freeze({...emphasis}),feasibility:derived.feasibility||{},constraints:Object.freeze(constraints),overallChange:derived.overall_change||null}),uncertainty:Object.freeze({broadDimensionMapping:!direct.length,requiresDiscoveryConfirmation:candidateConcerns.length>0})})
}

...
// Distinct supported problems must resolve through the governed registry to distinct proposed plans.
...
// Discovery provenance survives all the way into the proposed intervention.
...
// Planning asks for decision-changing selection evidence instead of guessing when it is absent.
...
// Low capacity keeps the proposed plan focused to one active component even with more than one accepted priority.
...
console.log('external Intelligence Discovery→Plan final-plan profile regressions passed');

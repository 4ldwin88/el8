...
assert.match(html,/your physical condition or how your body feels needs attention/,'Discovery handoff must explain reported body or physical-condition evidence');
assert.match(html,/your current activity level is something you want to improve/,'Discovery handoff must explain reported activity evidence');

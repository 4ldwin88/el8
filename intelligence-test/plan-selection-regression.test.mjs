...
assert.match(html,/A little more information is needed first\./,'Plan must preserve unresolved decision-critical insufficiency instead of manufacturing an Action');

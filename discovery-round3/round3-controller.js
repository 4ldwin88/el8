...
export function createRound3Session({concernIds=[], questionBank=[], labels={}, outerGuardrail=14}={}) {
  return {version:'round-3', observationLog:[], concernIds:[...concernIds], questionBank, labels, asked:[], questionsAsked:0, outerGuardrail, phase:concernIds.length?'discovery':'gateway', triaged:false, incomplete:false, resolutionStates:{}, driverKnown:{}, recoveryAttempts:{}};
}

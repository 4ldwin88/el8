...
// Sex is stable member context collected at signup. Measurement system is a later preference.
export const SIGNUP_FIELDS = Object.freeze(['name','email','birthdate','sex','country','timezone','password','passwordConfirmation']);
